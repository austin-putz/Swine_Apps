  ...
  tags$hr(),
   ...
   #sidebarLayout(
      #sidebarPanel(
         ...
         #             max = 3,
         #             value = 1, step=1),
         sliderInput(inputId="payment",
                     label="Payment per head:",
                     min = 30,
                     max = 70,
                     value = 43, step=1),
         sliderInput(inputId="wageRate",
                     label="Wage Rate per Hour:",
                     min = 0,
                     max = 30.00,
                     value = 0, step=0.50),
         sliderInput(inputId="laborHours",
                     label="Labor per pig (hours):",
                     min = 0,
                     max = 1,
                     value = 0.40, step=0.1),
         sliderInput(inputId="contractLength",
                     label="Length of contract:",
                     min = 1,
                     max = 20,
                     value = 15, step=1),
         # sliderInput(inputId="usefulLife",
         #             label="Useful life of building:",
         #             min = 10,
         #             max = 30,
         #             value = 24, step=1),
         sliderInput(inputId="taxRate",
                     label="Tax Rate (%):",
                     min = 0,
                     max = 50,
                     value = 15, step=1),
         numericInput(inputId="landCost",
                     label="Land Cost:",
                     min = 0,
                     max = 100000,
                     value = 0, step=500),
         numericInput(inputId="sitePrep",
                     label="Site Preparation Cost:",
                     min = 0,
                     max = 100000,
                     value = 60000, step=500),
         numericInput(inputId="buildingCost",
                     label="Building Cost:",
                     min = 0,
                     max = 1000000,
                     value = 316000, step=1000),
         numericInput(inputId="equipmentCost",
                     label="Equipment Cost:",
                     min = 0,
                     max = 1000000,
                     value = 258000, step=1000),
         numericInput(inputId="equityContribution",
                     label="Equity Contribution:",
                     min = 0,
                     max = 100000,
                     value = 0, step=1000),
         sliderInput(inputId="loanLength",
                     label="Loan Length (years):",
                     min = 1,
                     max = 20,
                     value = 12, step=1),
         sliderInput(inputId="loanTaxRate",
                     label="Loan Tax Rate (%):",
                     min = 0,
                     max = 30,
                     value = 4, step=1),
         sliderInput(inputId="maintenance",
                     label="Maintenance costs:",
                     min = 0,
                     max = 10000,
                     value = 2400, step=200),
         sliderInput(inputId="utilities",
                     label="Utility costs:",
                     min = 0,
                     max = 30000,
                     value = 16000, step=500),
         sliderInput(inputId="insurance",
                     label="Insurance costs:",
                     min = 0,
                     max = 10000,
                     value = 3200, step=200),
         sliderInput(inputId="taxes",
                     label="Tax costs:",
                     min = 0,
                     max = 10000,
                     value = 2100, step=100),
         sliderInput(inputId="waste",
                     label="Waste Management costs:",
                     min = 0,
                     max = 20000,
                     value = 11000, step=500),
         sliderInput(inputId="fertilizer",
                     label="Fertilizer value per year:",
                     min = 0,
                     max = 50000,
                     value = 25000, step=500),
        # actionButton(inputId="rerun", 
        #              label="Rerun Cash Flow"),
      #),
